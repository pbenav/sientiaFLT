...
<section class="bg-ex-light py-10">
    <div class="container-ex">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <!-- Phone -->
            <a href="tel:+34971000000" class="block bg-white rounded-2xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300 border border-gray-100 group">
                <div class="flex items-center gap-4">
                    <div class="w-14 h-14 rounded-2xl bg-red-50 flex items-center justify-center text-ex-accent group-hover:bg-ex-accent group-hover:text-white transition-colors duration-300 flex-shrink-0">
                        <svg class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                        </svg>
                    </div>
                    <div class="text-left">
                        <h3 class="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-0.5">Llama Ahora</h3>
                        <p class="text-lg font-bold text-gray-800" style="font-family:'Space Grotesk',sans-serif;">+34 971 000 000</p>
                    </div>
                </div>
            </a>
            <!-- Mobile -->
            <a href="tel:+34600000000" class="block bg-white rounded-2xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300 border border-gray-100 group">
                <div class="flex items-center gap-4">
                    <div class="w-14 h-14 rounded-2xl bg-blue-50 flex items-center justify-center text-ex-blue group-hover:bg-ex-blue group-hover:text-white transition-colors duration-300 flex-shrink-0">
                        <svg class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                        </svg>
                    </div>
                    <div class="text-left">
                        <h3 class="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-0.5">Móvil 24h</h3>
                        <p class="text-lg font-bold text-gray-800" style="font-family:'Space Grotesk',sans-serif;">+34 600 000 000</p>
                    </div>
                </div>
            </a>
            <!-- WhatsApp -->
            <a href="https://wa.me/34971000000" target="_blank" class="block bg-white rounded-2xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300 border border-gray-100 group">
                <div class="flex items-center gap-4">
                    <div class="w-14 h-14 rounded-2xl bg-green-50 flex items-center justify-center text-green-500 group-hover:bg-green-500 group-hover:text-white transition-colors duration-300 flex-shrink-0">
                    ...
                    <div class="text-left">
                        <h3 class="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-0.5">WhatsApp</h3>
                        <p class="text-lg font-bold text-gray-800" style="font-family:'Space Grotesk',sans-serif;">Abrir Chat</p>
                    </div>
                </div>
            </a>
        </div>
