...
<section class="bg-ex-light py-10">
    <div class="container-ex">
        <div class="text-center mb-8">
            <h2 class="ex-section-title" style="font-size:2rem;">Estos son nuestros Scooter para tí</h2>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <!-- Phone -->
            <div class="bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                <div class="w-14 h-14 bg-ex-accent/10 rounded-full flex items-center justify-center mx-auto mb-3">
                    <svg class="h-7 w-7 text-ex-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                    </svg>
                </div>
                <h3 class="font-bold text-ex-primary mb-1" style="font-family:'Space Grotesk',sans-serif;font-size:1.1rem;">LLAMA AHORA</h3>
                <a href="tel:+34971000000" class="ex-btn ex-btn-primary ex-btn-sm">+34 971 000 000</a>
            </div>
            <!-- Mobile -->
            <div class="bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                <div class="w-14 h-14 bg-ex-blue/10 rounded-full flex items-center justify-center mx-auto mb-3">
                    <svg class="h-7 w-7 text-ex-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                    </svg>
                </div>
                <h3 class="font-bold text-ex-primary mb-1" style="font-family:'Space Grotesk',sans-serif;font-size:1.1rem;">LLAMA AL MÓVIL</h3>
                <a href="tel:+34600000000" class="ex-btn ex-btn-secondary ex-btn-sm">+34 600 000 000</a>
            </div>
            <!-- WhatsApp -->
            <div class="bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                <div class="w-14 h-14 bg-green-500/10 rounded-full flex items-center justify-center mx-auto mb-3">
                    <svg class="h-7 w-7 text-green-500" fill="currentColor" viewBox="0 0 24 24">
                ...
                <h3 class="font-bold text-ex-primary mb-1" style="font-family:'Space Grotesk',sans-serif;font-size:1.1rem;">WhatsApp</h3>
                <a href="https://wa.me/34971000000" target="_blank" class="ex-btn ex-btn-primary ex-btn-sm" style="background:#25D366;">Chat</a>
            </div>
        </div>
